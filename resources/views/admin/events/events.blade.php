                    ...
                    <div class="col-sm-8">
                        <div class="bg-white my-3">
                            ...
                            <div class="p-3">
                                ...
                                <span class="text-sm"> March 31, 2023 by Administrator</span>
                    ...
                    <div class="col-sm-4 p-4">
                        ...
                        <div class="row py-3  mr-2 border-bottom ">
                            <div class="col-sm-6 p-0">
                                <img src="/assets/img/hackaton.jpg" class="img-fluid">
                            </div>
                            <div class="col-sm-6" data-aos="fade-left">
                                <a href=""> <span
                                        class="font-weight-bold text-sm-xs text-primary ">Hackathon</span></a><br>
                        ...
                        <div class="row py-3  mr-2 border-bottom ">
                            ...
                            <div class="col-sm-6" data-aos="fade-left">
                                <a href=""> <span class="font-weight-bold text-sm-xs text-primary">Knowledge
                                        Fest</span></a><br>
                                <span><i class="fa-regular fa-user text-dark"></i> Administrator</span><br>
                                <span><i class="fa-regular fa-calendar text-dark"></i> 2023-03-29<p>
                                    </p></span>
                        ...
                        <div class="row py-3  mr-2 border-bottom ">
                            <div class="col-sm-6 p-0">
                                <img src="/assets/img/ph.png" class="img-fluid">
                            </div>
                            <div class="col-sm-6" data-aos="fade-left">
                                <a href=""> <span class="font-weight-bold text-sm-xs text-primary">Pamaskong
                                        Handog</span></a><br>
                                <span><i class="fa-regular fa-user text-dark"></i> Administrator</span><br>
                                <span><i class="fa-regular fa-calendar text-dark"></i> 2023-03-29<p>
                                    </p></span>
                        ...
                        <div class="row py-3  mr-2 border-bottom ">
                            <div class="col-sm-6 p-0">
                                <img src="/assets/img/sitetutorial.png" class="img-fluid">
                            </div>
                            <div class="col-sm-6" data-aos="fade-left">
                                <a href=""> <span class="font-weight-bold text-sm-xs text-primary">SITE Tutorial
                                        Program</span></a><br>
                                <span><i class="fa-regular fa-user text-dark"></i> Administrator</span><br>
                                <span><i class="fa-regular fa-calendar text-dark"></i> 2023-03-29<p>
                                    </p></span>
